...
export const PACK_DEFS = {
  basic: {
    id: 'basic',
    name: 'باكس الحي',
    subtitle: 'شائع أو نادر',
    desc: 'يعطيك كرتاً عشوائياً من فئة الشائع أو النادر.',
    price: 150,
  ...
  legendary: {
    id: 'legendary',
    name: 'باكس الأسطورة',
    subtitle: 'نادر فأعلى — الرابع مضمون أسطوري',
    desc: 'نادر أو ملحمي أو أسطوري. كل 4 باكسات تضمن أسطوري!',
